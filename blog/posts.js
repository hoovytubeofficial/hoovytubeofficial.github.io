...
window.HT_POSTS = [
  {
    ...
    body: [
      ...
      "The reason I can walk away at all is the shape of the chain I came up through - shoulders of giants, that sort of beat. [Crowbar](https://developer.valvesoftware.com/wiki/Crowbar), dmxconvert.exe and [VTF Edit](https://developer.valvesoftware.com/wiki/VTFEdit) gave us [Blender Source Tools](https://developer.valvesoftware.com/wiki/Blender_Source_Tools), which gave us [Source IO](https://github.com/REDxEYE/SourceIO), which gave us HoovyTools, and every link carries the same license and bundles nothing You have to keep alive by hand. That is what hobbyists do here: small free tools that pull assets out of a game and into the software where You actually work. Nobody gets paid, the things get given away, and it is a good culture. It has fed me for years and I did not build any of the ground it stands on.",
